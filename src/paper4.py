...
class Paper4:
    ...
    def sp500_generate(self):
        ...
        combined['value'] = combined['book_equity_l1'] / \
            combined['market_equity_l1']
        ...
        combined['divp'] = combined['annual_dividends_l1'] / \
            combined['market_equity_l1']
        ...
        combined['cfp'] = (combined['ib_l1'] + combined['dp_l1']
                           ) / combined['market_equity_l1']
        ...
        combined['noa'] = (combined['at_l1'] - combined['che_l1']) - (combined['at_l1'] - combined['dlc_l1'] -
                                                                      combined['dltt_l1'] - combined['mib_l1'] - combined['pstk_l1'] - combined['ceq_l1'])

        # 17 Investment
        combined['ppegt_l1'] = combined['ppegt'].shift()
        combined['ppegt_pctchange'] = (
            combined['ppegt'] - combined['ppegt_l1']) / combined['ppegt_l1']
        combined['invt_l1'] = combined['invt'].shift()
        combined['invt_pctchange'] = (
            combined['invt'] - combined['invt_l1']) / combined['invt_l1']
        combined['inv'] = combined['ppegt_pctchange'] + \
            combined['invt_pctchange'] - combined['at_l12']
        ...
        combined['inv_growth'] = (
            combined['capx'] - combined['capx_l12']) / combined['capx_l12']
        ...
        # 31 Momentum (1 year)
        combined['mom12'] = combined['ret'].rolling(
            12).sum() - combined['ret_l1']
        ...
        combined['momrev'] = combined['ret_19'] + combined['ret_18'] + \
            combined['ret_17'] + combined['ret_16'] + \
            combined['ret_15'] + combined['ret_14']
        ...
        combined['ciss'] = np.log(
            combined['market_equity_l13'] / combined['market_equity_l60']) - combined['lrrev']

        # 48 Price
        combined['prc'] = np.log(
            combined['market_equity_l1'] / combined['shrout_l1'])
        ...
        # 50 Share Volume
        combined['shrout_3monthmovingaverage'] = combined.shrout.rolling(
            3).mean()
        combined['shvol'] = combined['shrout_3monthmovingaverage'] / \
            combined['shrout_l1']
        ...
        paper_4_features = pd.merge(paper_4_features, crsp_stocknames[[
        ...
        # Save to csv
        paper_4_features = paper_4_features[paper_4_features["permno"].isin(
            sp500)]
        ...
        for k, v in dic.items():
            if v.shape[0] > 1:
                ...
                if count == 1:
                    ...
                    try:
                        paper4_final = pd.concat(
                            [paper4_final, v], ignore_index=True)
                    except:
                        # delisted companies
                        pass
                ...
                sys.stdout.flush()
                count += 1
        paper4_final.to_csv('../result/sp500/paper4/paper4_features.csv')
        return ticker_files
...
if __name__ == "__main__":
    ...
    print('Please check /result/' + Paper4().stock_pool +
          '/paper4/paper4_features.csv')
